    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          <h1 className='font-medium text-2xl text-white mt-2'>{productData.name}</h1>
      ...
      <div className='mt-20'>
        <div className='flex'>
          ...
          <p className='border px-5 py-3 text-sm text-white'>Reviews (122)</p>
        </div>
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-100'>
